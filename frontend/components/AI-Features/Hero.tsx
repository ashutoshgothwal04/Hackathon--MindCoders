...
export default function Hero() {
  return (
    <div className=" bg-blue-600 dark:bg-bg-color rounded-lg shadow-lg p-8 mb-12 text-white">
    <div className="max-w-3xl mx-auto text-center">
      ...
      <Button size="lg" className="bg-white dark:text-black text-blue-700 hover:bg-blue-50">
        Try AI Matching
      </Button>
    </div>
  </div>
